...
public class ProjectConstants {
    ...
    public static final String DOMAIN = "https://dev.swisscows.com";
    public static final String URL_ACCOUNTS = "https://accounts.dev.swisscows.com";
    public static final String TITLE_VPN_PAGE = "Surf anonymously with VPN - Secure web surfing with Swisscows";
